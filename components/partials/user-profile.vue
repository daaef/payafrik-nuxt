                ...
                <div class="row w-100 flex-between">
                  ...
                  <div class="w-100 kyc--content">
                    ...
                    <div>
                      ...
                      <div
                        v-if="userDetails.kyc_passport_page1 && userDetails.kyc_passport_page1 !== ''"
                        class="user-avatar"
                        v-bind:style="{
                          backgroundImage: 'url(' + userDetails.kyc_passport_page1 + ')'
                        }"
                      ></div>
                    ...
                    <div>
                      ...
                      @click="openModal('uploadModal', 'NATIONAL-ID', 'FRONT' )"
                        v-if="!userDetails.kyc_id_front || userDetails.kyc_id_front === ''"
                        class="k+"
                      >
                        +
                      </a>
                      <div
                        ...
                        class="user-avatar"
                        v-bind:style="{
                          backgroundImage: 'url(' + userDetails.kyc_id_front + ')'
                        }"
                      ></div>
                      <span class="d-block text-center mt-12 c-dim-white"
                        >ID Front</span
                    ...
                    <div>
                      ...
                      @click="openModal('uploadModal', 'NATIONAL-ID', 'BACK' )"
                        v-if="!userDetails.kyc_id_back || userDetails.kyc_id_back === ''"
                        class="k+"
                      >
                        +
                      </a>
                  ...
                  <div class="w-100 mt-40 text-center">
                    <button v-if="!processing" class="user--btn" @click="updateProfile()">Update</button>
                    <button v-if="processing" class="user--btn" @click="updateProfile()">Updating...</button>
                  </div>
                </div>
              <!-- </form> -->
            </div>
                ...
                <div class="col-md-12">
                  ...
                  >
                    ...
                    <option value="KYC-SELFIE"
                      >KYC Selfie/Passport photo</option
                    >
                  </select>
                </div>
                <div class="col-md-12">
  ...
  methods: {
    ...
    async updateProfile() {
      ...
      try {
        ...
        console.log(e.response);
        this.$toast.error(e.response.statusText + ": Please make sure all ur fields are provided");
        this.processing = false;
      }
    },
