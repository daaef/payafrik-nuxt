    ...
    <div v-if="!processing">
      <div class="row">
        <div class="col-md-12 text-center">
          <img v-if="transactionData.ResponseCode === '00'" src="https://img.icons8.com/color/80/000000/checked--v1.png" />
          <img v-if="transactionData.ResponseCode !== '00'" src="https://img.icons8.com/fluent/80/000000/cancel.png" />
          <h6 v-if="transactionData.ResponseCode === '00'" class="yellow mt-2">Transaction Successful</h6>
          <h6 v-if="transactionData.ResponseCode !== '00'" class="failed mt-2">Transaction Error!</h6>
          <p class="mt-2">
  ...
  methods: {
    ...
    async updateTransaction() {
      ...
      const headers = {
        ...
        "pfk-user-token": this.$route.query.cid
      };

      const url = this.interswitchBaseUrl + "transactions/update/" + this.transactionRef;
      try {
